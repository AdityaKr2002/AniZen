 ...
 binding.controls.setContent {
    ...
    internal fun onObserverEvent(property: String, value: Double) {
        ...
        when (property) {
            ...
            "video-zoom" -> viewModel.videoZoom.value = value.toFloat()
            "video-pan-x" -> viewModel.videoPanX.value = value.toFloat()
            "video-pan-y" -> viewModel.videoPanY.value = value.toFloat()
