...
enum class PlayerButton(
    ...
    BackArrow(ArrowBack, MR.strings.player_button_back_arrow),
    VideoTitle(Title, MR.strings.player_button_video_title),
    AutoPlay(PlayCircle, MR.strings.player_button_autoplay),
    Cast(SmartDisplay, MR.strings.player_button_cast),
    SubtitleTracks(Subtitles, MR.strings.player_button_subtitle_tracks),
    AudioTracks(Audiotrack, MR.strings.player_button_audio_tracks),
    QualityTracks(HighQuality, MR.strings.player_button_quality_tracks),
    MoreOptions(MoreVert, MR.strings.player_button_more_options),
    PlaybackSpeed(Speed, MR.strings.player_button_playback_speed),
    CurrentChapter(Bookmarks, MR.strings.player_button_current_chapter),
    LockControls(LockOpen, MR.strings.player_button_lock_controls),
    ScreenRotation(ScreenRotation, MR.strings.player_button_screen_rotation),
    PictureInPicture(PictureInPictureAlt, MR.strings.player_button_picture_in_picture),
    AspectRatio(AspectRatio, MR.strings.player_button_aspect_ratio),
    VideoZoom(ZoomIn, MR.strings.player_button_video_zoom),
    SkipIntro(FastForward, MR.strings.player_button_skip_intro),
    CustomButton(TouchApp, MR.strings.player_button_custom_button),
}
