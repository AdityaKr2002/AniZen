...
enum class PlayerButton(
    ...
    BackArrow(Icons.AutoMirrored.Outlined.ArrowBack, MR.strings.player_button_back_arrow),
    VideoTitle(Icons.Outlined.Title, MR.strings.player_button_video_title),
    AutoPlay(Icons.Outlined.PlayCircle, MR.strings.player_button_autoplay),
    Cast(Icons.Outlined.SmartDisplay, MR.strings.player_button_cast),
    SubtitleTracks(Icons.Outlined.Subtitles, MR.strings.player_button_subtitle_tracks),
    AudioTracks(Icons.Outlined.Audiotrack, MR.strings.player_button_audio_tracks),
    QualityTracks(Icons.Outlined.HighQuality, MR.strings.player_button_quality_tracks),
    MoreOptions(Icons.Outlined.MoreVert, MR.strings.player_button_more_options),
    PlaybackSpeed(Icons.Outlined.Speed, MR.strings.player_button_playback_speed),
    CurrentChapter(Icons.Outlined.Bookmarks, MR.strings.player_button_current_chapter),
    LockControls(Icons.Outlined.LockOpen, MR.strings.player_button_lock_controls),
    ScreenRotation(Icons.Outlined.ScreenRotation, MR.strings.player_button_screen_rotation),
    PictureInPicture(Icons.Outlined.PictureInPictureAlt, MR.strings.player_button_picture_in_picture),
    AspectRatio(Icons.Outlined.AspectRatio, MR.strings.player_button_aspect_ratio),
    VideoZoom(Icons.Outlined.ZoomIn, MR.strings.player_button_video_zoom),
    SkipIntro(Icons.Outlined.FastForward, MR.strings.player_button_skip_intro),
    CustomButton(Icons.Outlined.TouchApp, MR.strings.player_button_custom_button),
}
